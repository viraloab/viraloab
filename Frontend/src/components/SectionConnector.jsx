...
const SectionConnector = ({ variant = 'default' }) => {
    ...
    const renderConnector = () => {
        switch (variant) {
            case 'wave':
                return (
                    <div ref={connectorRef} className="relative h-32 w-full overflow-hidden bg-transparent opacity-0 animate-appear-duration will-change-[opacity,transform]">
                        <div className="absolute inset-0 flex items-center justify-center">
                            <svg className="w-full h-32 text-dark-900" viewBox="0 0 1440 120" preserveAspectRatio="none">
                                <path 
            ...
            case 'dots':
                return (
                    <div ref={connectorRef} className="relative h-24 w-full flex items-center justify-center opacity-0 animate-appear-duration will-change-[opacity,transform]">
            ...
            case 'tech':
                return (
                    <div ref={connectorRef} className="relative h-20 w-full opacity-0 animate-appear-duration will-change-[opacity,transform]">
            ...
            default:
                return (
                    <div ref={connectorRef} className="relative h-28 w-full opacity-0 animate-appear-duration will-change-[opacity,transform]">
