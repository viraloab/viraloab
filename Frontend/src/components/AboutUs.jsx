        ...
        <section className="py-24 relative overflow-hidden" id="about">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-display font-bold gradient-text mb-6">Our Story</h2>
                ...
                {/* Team Section */}
                <h3 className="text-2xl md:text-3xl font-display font-bold text-center text-white mb-12">Meet Our Leadership</h3>
                ...
                <div className="mt-20 text-center">
                    <h3 className="text-2xl font-display font-bold text-white mb-3">Our Values</h3>
