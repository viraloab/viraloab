  ...
  const steps = [
    {
      ...
      title: "Discovery",
      description:
        "We begin by deeply understanding your goals, challenges, and vision to establish clear objectives.",
      icon: <FaSearch />,
    ...
    },
    {
      ...
      title: "Strategy",
      description:
        "Our team crafts a comprehensive, tailored plan aligned with your business objectives.",
      icon: <FaLightbulb />,
    ...
    },
    {
      ...
      title: "Execution",
      description:
        "We bring your vision to life with precision, creativity, and cutting-edge technology.",
      icon: <FaCode />,
    ...
    },
    {
      ...
      title: "Optimization",
      description:
        "We continuously improve and refine our approach based on data-driven insights and feedback.",
      icon: <FaCogs />,
    ...
    },
    {
      ...
      title: "Launch",
      description:
        "Your solution is deployed with a strategic rollout plan ensuring maximum impact and adoption.",
      icon: <FaRocket />,
  ...
  const detailedSteps = [
    {
      ...
      description:
        "The foundation of our approach begins with a deep dive into your business ecosystem. We conduct thorough research to understand your industry, competitors, target audience, and unique challenges.",
      keyPoints: [
    ...
    },
    {
      ...
      description:
        "With insights from the discovery phase, we develop a comprehensive roadmap that outlines the strategic approach, technical requirements, and creative direction tailored specifically to your goals.",
      keyPoints: [
      ...
      duration: "1-3 weeks",
      deliverables:
        "Strategic roadmap, Technical specifications, Creative brief",
    },
    {
      title: "Execution",
      icon: <FaCode className="text-accent-500" />,
      description:
        "This is where concepts transform into reality. Our cross-functional teams collaborate to build your solution with precision and creativity, maintaining open communication throughout the process.",
      keyPoints: [
      ...
      duration: "4-12 weeks",
      deliverables:
        "Working prototypes, Code repositories, Design assets, Documentation",
    },
    {
      title: "Optimization",
      icon: <FaCogs className="text-primary-400" />,
      description:
        "We believe in continuous improvement through data-driven decisions. Our team analyzes performance metrics and user feedback to refine and enhance your solution for optimal results.",
      keyPoints: [
      ...
      duration: "Ongoing",
      deliverables:
        "Performance reports, Optimization recommendations, Implementation updates",
    },
    {
      title: "Launch",
      icon: <FaRocket className="text-secondary-400" />,
      description:
        "The culmination of our collaborative efforts, launch day is strategically planned to ensure a smooth transition and maximum impact. We provide support throughout the deployment process and beyond.",
      keyPoints: [
      ...
      duration: "1-2 weeks",
      deliverables:
        "Final deliverables, Training documentation, Support plan, Success metrics",
    },
  ];
  ...
  const additionalInfo = [
    {
      ...
      description:
        "We believe in transparent, collaborative partnerships. Our clients are integral to the process, with regular check-ins, updates, and opportunities for feedback at every stage.",
    },
    {
      title: "Results-Focused Approach",
      icon: <FaChartLine className="text-primary-500" />,
      description:
        "Every decision we make is guided by data and aligned with your business goals. We track key metrics throughout the process to ensure we're delivering measurable results.",
    },
    {
      title: "Flexible Timeline",
      icon: <FaRegClock className="text-secondary-500" />,
      description:
        "We understand that each project is unique. Timelines are customized based on project complexity, scope, and your specific needs while maintaining efficiency and quality.",
    },
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-lg">
            Our process is designed to deliver exceptional results while keeping
            you informed every step of the way. We believe in transparency and
            collaboration, ensuring your project exceeds expectations.
          </p>
        </div>
            ...
            <div className="h-full flex flex-col justify-center">
              <div className="mb-10">
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-3xl font-display font-bold text-white ml-4">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="card-3d-content relative w-64 h-64">
                  {/* Glowing circle */}
                  <div
                    className={`absolute inset-0 rounded-full bg-gradient-to-br ${step.color} opacity-20 blur-2xl animate-pulse-slow`}
                  ></div>
            ...
            <div className="overflow-y-auto flex-1 p-6">
              <div className="text-center mb-10">
                <p className="text-gray-300 max-w-3xl mx-auto">
                  At Viraloab, we follow a structured yet flexible approach
                  designed to deliver exceptional results while adapting to your
              ...
              <div className="space-y-12 mb-12">
                {detailedSteps.map((step, index) => (
                  <div
                    key={index}
                    className="glass-card p-6 rounded-xl border border-white/10 relative overflow-hidden group"
                  >
                    {/* Step number */}
              ...
              <div className="mb-12">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {additionalInfo.map((info, index) => (
                    <div
                      key={index}
                      className="glass-card p-6 rounded-xl border border-white/10 text-center hover:transform hover:-translate-y-2 transition-transform duration-300"
                    >
              ...
              <div className="text-center">
                <button
                  ...
                  className="neo-button group"
                >
                  <span className="relative z-10 text-white px-8 py-3">
