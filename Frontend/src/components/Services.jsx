...
import { FaChevronRight, FaTimes, FaSearch, FaLaptopCode, FaPalette, FaMobileAlt, FaBullhorn, FaCode } from 'react-icons/fa';
...
const Services = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            description: 'Custom digital solutions that deliver exceptional user experiences across all platforms.',
            details: [
        ...
        },
        {
            ...
            description: 'Custom AI-powered tools and intelligent chatbots to automate processes and enhance customer experiences.',
            details: [
        ...
        },
        {
            ...
            description: 'Engaging social media content that captivates your audience and builds your brand presence.',
            details: [
        ...
        },
        {
            ...
            description: 'Comprehensive branding services to establish a powerful and consistent brand identity.',
            details: [
        ...
        },
        {
            ...
            description: 'Strategic influencer partnerships that drive brand awareness and customer engagement.',
            details: [
        ...
        <section className="py-24 relative overflow-hidden" id="services">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-display font-bold text-white mb-8">Services We Offer</h2>
                    <div className="h-1 w-20 bg-gradient-to-r from-primary-500 to-secondary-500 mx-auto mb-8"></div>
                    <p className="text-gray-300 max-w-2xl mx-auto text-lg">
                        We provide cutting-edge solutions to help your business grow and thrive in the digital landscape.
                    </p>
                </div>
                        ...
                        >
                            <div className="relative glass-card h-full rounded-2xl overflow-hidden p-6 border border-white/10 hover:border-white/30 transition-all duration-300 hover:-translate-y-2">
                                ...
                                <div className="card-3d-content h-full flex flex-col">
                                    {/* Icon */}
                                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 bg-gradient-to-br ${service.color} shadow-lg`}>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-white/10">
                            <div className="flex items-center">
                                <div className={`w-12 h-12 rounded-lg flex items-center justify-center bg-gradient-to-br ${selectedService.color} mr-4`}>
                                    <div className="text-white">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {selectedService.details.map((detail, index) => (
                                    <div key={index} className="flex items-start">
                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center bg-gradient-to-br ${selectedService.color} mr-3 mt-0.5 flex-shrink-0`}>
