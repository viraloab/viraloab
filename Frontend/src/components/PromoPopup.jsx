...
const PromoPopup = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      trackPopupEvent("duration", "promo_popup", {
  ...
  const handleContactClick = () => {
    trackPopupEvent("cta_click", "promo_popup", {
        ...
        <div className="p-8 relative z-10">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-300 mb-4">
              We offer complete branding and development solutions to help your
              business stand out in today's competitive market.
            </p>
